...
so <- FindNeighbors(so, dims = 1:5)  #5 PCs from elbowplot
gc()
...
so_temp <- subset(so, gene %in% c("non-targeting", "KMT2B"))
...
```{r}
# This was done in the "differential_expression_mixscale.R" file - takes multiple days
# Differential expression per gRNA
#gRNA_PRTBs <- c("SOX10-g1", "SOX10-g10", "SOX10-g2", "SOX10-g3", "SOX10-g5", "SOX10-g6", "SOX10-g7", "SOX10-g8", "SOX10-g9")
#de_res_gRNA <- Run_wmvRegDE(object = so, assay = "RNA", slot = "counts",
#                            labels = "NT_gRNA", nt.class.name = "NonTargeting",
